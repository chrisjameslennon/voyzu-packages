...
export async function InventoryControlAccountsPage() {
  ...
  return (
    <div className={`${layoutStyles.listView} ${layoutStyles.compactMobilePadding}`}>
      ...
      <div className={layoutStyles.slotBody}><InventoryControlAccountsContent controlAccounts={controlAccounts} basePath="/ledger/settings/control-accounts/inventory" /></div>
    </div>
  );
}
