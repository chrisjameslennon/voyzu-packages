...
export const httpApiRoutes = {
  "ledger.financial-document-types.list": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/financial-document-types",
  ...
  "ledger.financial-document-types.filter": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/financial-document-types/filter",
  ...
  "ledger.financial-document-types.search": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/financial-document-types/search",
  ...
  "ledger.financial-document-types.batchGet": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/financial-document-types/batch/get",
  ...
  "ledger.financial-document-types.get": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/financial-document-types/[code]",
