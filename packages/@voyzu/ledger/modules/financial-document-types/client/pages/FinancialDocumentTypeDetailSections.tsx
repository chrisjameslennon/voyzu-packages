...
import { getDrCrColor } from "../../../common/client/index";
import { detailLinkWithBackContext } from "../../../common/client/index";
import { ledgerName } from "../../../common/client/index";
import type {
...
function DynamicPostingEntryPointCard({
  ...
  const itemPostingProfilesHref = routePrefix.startsWith("/ledger")
    ...
    <div className={localStyles.postingCard}>
      ...
      {showInventoryProcessingRules && (
        <div className={localStyles.itemPostingProfilesBox}>
          ...
          <a className={`${typography.link} ${localStyles.itemPostingProfilesLink}`} href="/ledger/integration/inventory-processing/rules">
