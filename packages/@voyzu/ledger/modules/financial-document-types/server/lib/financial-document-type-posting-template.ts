...
import type { FinancialDocumentDefaultResponseDto } from "../../../financial-document-defaults/types/index";
...
import { getControlAccount } from "../../../control-accounts/server/index";
import { listInventoryControlAccountSettings } from "../../../inventory-control-accounts/server/index";
import {
...
import { listTaxControlAccounts } from "../../../tax-control-accounts/server/index";
  ...
  return {
    ...
    managedIn: {
      link: {
        ...
        href: "/ledger/inventory/item-posting-profiles",
      },
      badge: { label: code },
    },
  };
...
function prefixManagedLinks(
  ...
  const managedRoutePrefix = routePrefix.startsWith("/ledger") ? "/ledger/settings" : routePrefix;
