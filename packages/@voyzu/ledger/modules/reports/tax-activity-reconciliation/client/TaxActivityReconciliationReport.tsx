...
import type { TaxActivityReconciliationResponseDto } from "../types/tax-activity-reconciliation.response.dto";
...
export function TaxActivityReconciliationReport({
  ...
  const printableBase = "/ledger/reports/tax-activity-reconciliation/printable";
