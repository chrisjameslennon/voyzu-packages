...
import type { ProfitLossBreakdownDto, ProfitLossAnalysisResponseDto, ProfitLossDimensionSelectionDto } from "../types/profit-loss-analysis.response.dto";
import type { DimensionResponseDto } from "../../../dimensions/types/index";
...
export function ProfitLossAnalysisReport({
  ...
  const printableBase = "/ledger/reports/profit-loss-analysis/printable";
