...
import { getHasPostingsColor, getStatusSemanticColor } from "../../common/client/index";
import { ChangeCodeAvailability, Deactivate, Delete } from "../domain/operation-policy";
import type { GlAccountCategoryResponseDto } from "../../gl-account-categories/types/index";
import type { GlAccountResponseDto, GlAccountUpdateRequestDto } from "../types/index";
...
const LIST_PATH = "/ledger/settings/gl-accounts";
...
export function GlAccountDetail({ account, categories, readOnly = false, isArchived = false }: CompanyGlAccountDetailProps) {
