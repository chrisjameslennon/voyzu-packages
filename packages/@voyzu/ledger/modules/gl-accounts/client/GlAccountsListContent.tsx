...
import type { GlAccountCreateRequestDto, GlAccountResponseDto } from "../types/index";
import {
  Badge,
  Breadcrumbs,
  Button,
...
export function GlAccountsListContent({
  accounts,
  categories,
  readOnly = false,
  isArchived = false,
      ...
      <div className={layoutStyles.listBody}>
        <div className={layoutStyles.slotBody}>
          <DataTable<GlAccountResponseDto, number>
            ...
            onRowClick={(account) => router.push(`/ledger/settings/gl-accounts/${encodeURIComponent(account.code)}`)}
