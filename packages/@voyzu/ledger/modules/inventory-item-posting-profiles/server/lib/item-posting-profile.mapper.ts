import type { ItemPostingProfileCreateRequestDto } from "../../types/index";
import type { ItemPostingProfilePatchRequestDto } from "../../types/index";
import type { ItemPostingProfileResponseDto } from "../../types/index";
import type { ItemPostingProfileUpdateRequestDto } from "../../types/index";
...
export function toDto(row: ItemPostingProfileRow): ItemPostingProfileResponseDto {
  return {
    ...
    audit: {
      ...
      updated: {
        date: new Date(row.updated_date ?? row.creation_date ?? "").toISOString(),
