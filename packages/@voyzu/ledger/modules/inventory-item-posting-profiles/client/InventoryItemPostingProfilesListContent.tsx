...
import { CompanySettingsTitleBadges, getStatusSemanticColor } from "../../common/client/index";
import { AssignGLAccount, Deactivate, Delete, PostingAccountEnabled, PostingAccountRequired } from "../domain/operation-policy";
import { AddItemPostingProfileModal } from "./index";
import { useEffect, useMemo, useState } from "react";
import { useRouter } from "next/navigation";

import type { ItemPostingProfileCreateRequestDto, ItemPostingProfileGlRefDto, ItemPostingProfileResponseDto } from "../types/index";
...
export function InventoryItemPostingProfilesListContent({
  profiles,
  glAccounts,
  basePath = "/ledger/inventory/item-posting-profiles",
