...
export const httpApiRoutes = {
  "ledger.control-accounts.ar-list": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/ar-control-accounts",
    loadHandler: () => import("./server/http-api/control-account.http.handlers").then((module) => module.handleListAr),
  ...
  "ledger.control-accounts.ar-get": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/ar-control-accounts/[code]",
