...
import styles from "./ar-control-account-summary-panels.module.css";
...
export function ArControlAccountSummaryPanels({ accounts, basePath }: CompanyArControlAccountSummaryPanelsProps) {
