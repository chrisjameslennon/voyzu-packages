...
import { ControlAccountSummaryPanel } from "./index";
import type { ControlAccountSettingResponseDto } from "../types/index";

import styles from "./ap-control-account-summary-panels.module.css";
...
export function ApControlAccountSummaryPanels({ accounts, basePath }: CompanyApControlAccountSummaryPanelsProps) {
