...
export const httpApiRoutes = {
  "ledger.gl-account-categories.list": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/gl-account-categories",
  ...
  "ledger.gl-account-categories.filter": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/gl-account-categories/filter",
  ...
  "ledger.gl-account-categories.search": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/gl-account-categories/search",
  ...
  "ledger.gl-account-categories.batchCreate": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/gl-account-categories/batch",
  ...
  "ledger.gl-account-categories.batchGet": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/gl-account-categories/batch/get",
  ...
  "ledger.gl-account-categories.batchActivate": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/gl-account-categories/batch-activate",
  ...
  "ledger.gl-account-categories.batchDeactivate": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/gl-account-categories/batch-deactivate",
  ...
  "ledger.gl-account-categories.activate": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/gl-account-categories/[code]/activate",
  ...
  "ledger.gl-account-categories.deactivate": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/gl-account-categories/[code]/deactivate",
  ...
  "ledger.gl-account-categories.get": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/gl-account-categories/[code]",
