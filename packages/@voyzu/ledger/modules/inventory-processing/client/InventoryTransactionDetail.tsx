...
export function InventoryTransactionDetail({ record, organization, financeActivityId }: {
  ...
  const printablePath = `/ledger/integration/inventory-processing/inventory-transactions/${financeActivityId}/printable`;
