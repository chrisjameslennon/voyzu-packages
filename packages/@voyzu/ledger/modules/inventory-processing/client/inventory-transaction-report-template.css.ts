export const inventoryTransactionReportCss = `
.reportPage { --report-font: "Inter", "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; --text-main: #1f1f1f; --text-muted: #6b7280; --line-strong: #404040; --line-mid: #d8d8d8; --line-soft: #ececec; box-sizing: border-box; font-family: var(--report-font); font-size: 12px; line-height: 1.4; color: var(--text-main); background: #fff; }
...
@media print { .reportFooter { display: none; } .section { background: #f4f5f7 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; page-break-inside: avoid; } }
`;

export const inventoryTransactionReportStyles = {
  addressBlock: "addressBlock", code: "code", documentTypeLine: "documentTypeLine",
  documentDateLine: "documentDateLine", documentLink: "documentLink", grid12: "grid12",
  label: "label", line: "line", metaRow: "metaRow", metaSlot: "metaSlot",
  metaValue: "metaValue", muted: "muted", name: "name", notes: "notes",
  number: "number", reportCompanyName: "reportCompanyName", reportFooter: "reportFooter",
  reportHeader: "reportHeader", reportHeaderLine: "reportHeaderLine",
  reportHeaderLineStrong: "reportHeaderLineStrong", reportPage: "reportPage",
  reportSection: "reportSection", rowBordered: "rowBordered", section: "section",
  sectionTitle: "sectionTitle", table: "table", topCompany: "topCompany",
