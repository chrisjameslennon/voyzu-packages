      ...
      <div className={layoutStyles.detailView}>
        ...
        <main className={layoutStyles.mainSection}>
          <section className={detailStyles.card}>
            ...
            <DetailBackButton fallbackHref={"/ledger/journals"} from={from} fromCode={fromCode} />
          </section>
        </main>
      </div>
    );
  ...
  const viewItems: DropdownMenuItem[] = [
      ...
      onSelect: () => {
        ...
        router.push(
          detailLinkWithBackContext(
            `/ledger/subledgers/ar/ledger-entries/${encodeURIComponent(journal.arSubledgerEntryCode)}`,
            "journal",
            journal.code,
          ),
        );
    ...
    },
    {
      ...
      onSelect: () => {
        ...
        router.push(
          detailLinkWithBackContext(
            `/ledger/subledgers/ap/ledger-entries/${encodeURIComponent(journal.apSubledgerEntryCode)}`,
            "journal",
            journal.code,
          ),
        );
    ...
    },
    {
      ...
      onSelect: () => {
        ...
        router.push(
          detailLinkWithBackContext(
            `/ledger/subledgers/tax/ledger-entries/${encodeURIComponent(journal.taxLedgerEntryCode)}`,
            "journal",
            journal.code,
          ),
        );
