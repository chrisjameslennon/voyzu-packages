...
export const httpApiRoutes = {
  "ledger.financial-years.list": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/financial-years",
  ...
  "ledger.financial-years.exportZip": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/financial-years/export",
  ...
  "ledger.financial-years.get": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/financial-years/[code]",
  ...
  "ledger.financial-years.open": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/financial-years/[code]/open",
  ...
  "ledger.financial-years.close": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/financial-years/[code]/close",
  ...
  "ledger.financial-years.reopen": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/financial-years/[code]/reopen",
  ...
  "ledger.financial-years.periodsList": {
    ...
    method: "GET",
    path: "/ledger/[companyCode]/financial-years/[code]/periods",
  ...
  "ledger.financial-years.periodsClose": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/financial-years/[code]/periods/[periodCode]/close",
  ...
  "ledger.financial-years.periodsReopen": {
    ...
    method: "POST",
    path: "/ledger/[companyCode]/financial-years/[code]/periods/[periodCode]/reopen",
