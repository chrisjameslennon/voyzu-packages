...
import type { InventoryLedgerEntryDetailResponseDto } from "../../types/index";
import {
  Badge,
  Breadcrumbs,
  Button,
    ...
    <div className={`${layout.detailView} ${layout.detailViewWithStatusRail}`}>
      <header className={layout.detailHeader}>
        ...
        <div className={layout.slotActions}>
          <div className={detailStyles.headerActions}><DetailBackButton fallbackHref={"/ledger/inventory/ledger"} from={from} fromCode={fromCode} /></div>
        </div>
      </header>
