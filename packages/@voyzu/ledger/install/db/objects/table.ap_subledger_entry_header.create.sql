CREATE TABLE IF NOT EXISTS ap_subledger_entry_header (
    ...
    ap_counterparty_id          BIGINT NOT NULL,
    ...
    CONSTRAINT fk_ap_header_company          FOREIGN KEY (finance_organization_id)           REFERENCES finance_organization(id) ON DELETE CASCADE,
    CONSTRAINT fk_ap_header_journal          FOREIGN KEY (journal_header_id)    REFERENCES journal_header(id),
    CONSTRAINT fk_ap_header_counterparty     FOREIGN KEY (ap_counterparty_id)   REFERENCES ledger_ap_counterparty_snapshot(id),
    CONSTRAINT fk_ap_header_document_type    FOREIGN KEY (document_type_code) REFERENCES financial_document_type(code),
    CONSTRAINT fk_ap_header_financial_year   FOREIGN KEY (financial_year_id)    REFERENCES fiscal_year(id),
    CONSTRAINT fk_ap_header_financial_period FOREIGN KEY (financial_period_id)  REFERENCES fiscal_period(id),
    CONSTRAINT fk_ap_header_base_currency    FOREIGN KEY (base_currency_code)   REFERENCES currency(code)
);
