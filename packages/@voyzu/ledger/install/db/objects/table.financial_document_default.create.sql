...
CREATE TABLE IF NOT EXISTS financial_document_default (
    ...
    CONSTRAINT fk_financial_document_default_company FOREIGN KEY (finance_organization_id) REFERENCES finance_organization(id) ON DELETE CASCADE,
    CONSTRAINT fk_financial_document_default_gl_account FOREIGN KEY (finance_organization_id, gl_account_id) REFERENCES gl_account(finance_organization_id, id),
    CONSTRAINT fk_financial_document_default_bank_cash_control_account FOREIGN KEY (finance_organization_id, bank_cash_control_account_id) REFERENCES bank_cash_control_account(finance_organization_id, id),
    ...
    CONSTRAINT pk_financial_document_default PRIMARY KEY (finance_organization_id, document_code, code)
);

CREATE UNIQUE INDEX IF NOT EXISTS ux_financial_document_default_document_bank_cash_control_account
    ON financial_document_default(finance_organization_id, document_code, bank_cash_control_account_id)
