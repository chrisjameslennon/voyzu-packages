CREATE TABLE IF NOT EXISTS gl_account (
    ...
    CONSTRAINT fk_account_category
        FOREIGN KEY (finance_organization_id, account_category_id)
        REFERENCES gl_account_category(finance_organization_id, id),

    CONSTRAINT uq_gl_account_company_code UNIQUE (finance_organization_id, code),
    CONSTRAINT uq_gl_account_finance_organization_id UNIQUE (finance_organization_id, id)
);
