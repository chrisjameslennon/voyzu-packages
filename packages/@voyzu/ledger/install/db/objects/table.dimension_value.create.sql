...
CREATE TABLE IF NOT EXISTS dimension_value (
    ...
    CONSTRAINT fk_dimension_value_company FOREIGN KEY (finance_organization_id) REFERENCES finance_organization(id) ON DELETE CASCADE,
    CONSTRAINT fk_dimension_value_dimension FOREIGN KEY (finance_organization_id, dimension_id) REFERENCES dimension(finance_organization_id, id) ON DELETE CASCADE,
    CONSTRAINT dimension_value_dimension_id_id_unique UNIQUE (finance_organization_id, dimension_id, id),
...
CREATE UNIQUE INDEX IF NOT EXISTS dimension_value_name_unique
    ON dimension_value (finance_organization_id, dimension_id, lower(name));
