...
DROP TABLE IF EXISTS ledger_ar_counterparty_snapshot;
DROP TABLE IF EXISTS ledger_ap_counterparty_snapshot;
...
DROP TABLE IF EXISTS inventory_item_posting_profile_assignment;
