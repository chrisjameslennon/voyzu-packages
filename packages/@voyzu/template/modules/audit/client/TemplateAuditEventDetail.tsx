...
import styles from "./template-audit.module.css";
...
export function TemplateAuditEventDetail({ event }: { event: AuditEventResponseDto }) {
  return (
      ...
      <header className={layoutStyles.pageHeaderGrid}>
        ...
        <div className={layoutStyles.pageTitle}>
          ...
          <div className={layoutStyles.headerActions}>
            <DetailBackButton fallbackHref="/template/audit" preserveSearchParams />
          </div>
        </div>
      </header>
