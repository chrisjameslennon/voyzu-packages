...
export const apiDefinitions = {
  getSelection: {
    ...
    handler: (request: any) => handleGetOrganizationSelection(request),
  ...
  setSelection: {
    method: "PUT",
    path: "/organization-selection",
    handler: (request: any) => handleSetOrganizationSelection(request),
  ...
  accessArchivedSelection: {
    ...
    handler: (request: any) => handleAccessArchivedOrganization(request),
    request: { contentType: "application/json", body: OrganizationSelectionUpdateRequestDto },
