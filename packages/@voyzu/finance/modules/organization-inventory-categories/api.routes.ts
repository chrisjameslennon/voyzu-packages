...
export const apiDefinitions = {
  list: {
    method: "GET",
    path: "/finance/template/inventory/categories",
  ...
  filter: {
    method: "POST",
    path: "/finance/template/inventory/categories/filter",
  ...
  search: {
    method: "GET",
    path: "/finance/template/inventory/categories/search",
  ...
  batchGet: {
    method: "POST",
    path: "/finance/template/inventory/categories/batch/get",
  ...
  batchCreate: {
    method: "POST",
    path: "/finance/template/inventory/categories/batch/create",
  ...
  batchUpdate: {
    method: "PUT",
    path: "/finance/template/inventory/categories/batch",
  ...
  get: {
    method: "GET",
    path: "/finance/template/inventory/categories/[code]",
  ...
  activate: {
    method: "POST",
    path: "/finance/template/inventory/categories/[code]/activate",
  ...
  deactivate: {
    method: "POST",
    path: "/finance/template/inventory/categories/[code]/deactivate",
  ...
  batchActivate: {
    method: "POST",
    path: "/finance/template/inventory/categories/batch-activate",
  ...
  batchDeactivate: {
    method: "POST",
    path: "/finance/template/inventory/categories/batch-deactivate",
