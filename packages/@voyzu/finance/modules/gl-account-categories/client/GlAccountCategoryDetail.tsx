...
import type { GlAccountCategoryPatchRequestDto, GlAccountCategoryResponseDto } from "../types/index";
...
import { GlAccountCategoryDetailsForm } from "./index";
...
export function GlAccountCategoryDetail({
  category,
