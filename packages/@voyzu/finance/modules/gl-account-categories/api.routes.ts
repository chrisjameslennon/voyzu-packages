...
export const apiDefinitions = {
  list: {
    ...
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleList),
  ...
  filter: {
    ...
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleFilter),
  ...
  search: {
    ...
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleSearch),
  ...
  create: {
    method: "POST",
    path: "/finance/[companyCode]/gl-account-categories",
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleCreate),
  ...
  batchCreate: {
    ...
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleBatchCreate),
  ...
  batchGet: {
    ...
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleBatchGet),
  ...
  batchUpdate: {
    method: "PUT",
    path: "/finance/[companyCode]/gl-account-categories/batch",
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleBatchUpdate),
  ...
  batchPatch: {
    method: "PATCH",
    path: "/finance/[companyCode]/gl-account-categories/batch",
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleBatchPatch),
  ...
  batchDelete: {
    method: "DELETE",
    path: "/finance/[companyCode]/gl-account-categories/batch",
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleBatchDelete),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } } }, contentType: "application/json", body: CodesRequestDto },
  ...
  batchActivate: {
    ...
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleBatchActivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } } }, contentType: "application/json", body: CodesRequestDto },
  ...
  batchDeactivate: {
    ...
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleBatchDeactivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } } }, contentType: "application/json", body: CodesRequestDto },
  ...
  activate: {
    ...
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleActivate),
  ...
  deactivate: {
    ...
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleDeactivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } }, code: { description: "Business code of the requested record.", schema: { type: "string" } } } },
    summary: "Deactivate",
  ...
  get: {
    ...
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleGet),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } }, code: { description: "Business code of the requested record.", schema: { type: "string" } } } },
    summary: "Get",
  ...
  update: {
    method: "PUT",
    path: "/finance/[companyCode]/gl-account-categories/[code]",
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleUpdate),
  ...
  patch: {
    method: "PATCH",
    path: "/finance/[companyCode]/gl-account-categories/[code]",
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handlePatch),
  ...
  delete: {
    method: "DELETE",
    path: "/finance/[companyCode]/gl-account-categories/[code]",
    loadHandler: () => import("./server/api/gl-account-category.http.handlers").then((module) => module.handleDelete),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } }, code: { description: "Business code of the requested record.", schema: { type: "string" } } } },
    summary: "Delete",
