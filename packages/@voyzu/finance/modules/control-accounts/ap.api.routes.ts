...
export const apiDefinitions = {
  list: {
    ...
    loadHandler: () => import("./server/api/control-account.http.handlers").then((module) => module.handleListAp),
  ...
  get: {
    ...
    loadHandler: () => import("./server/api/control-account.http.handlers").then((module) => module.handleGet),
  ...
  patch: {
    method: "PATCH",
    path: "/finance/[companyCode]/ap-control-accounts/[code]",
    loadHandler: () => import("./server/api/control-account.http.handlers").then((module) => module.handlePatch),
