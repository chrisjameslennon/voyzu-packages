...
export const operations = {
  createGlAccountCategoryOrganizationGlAccountCategories: createGlAccountCategory,
  getGlAccountCategoryOrganizationGlAccountCategories: getGlAccountCategory,
  updateGlAccountCategoryOrganizationGlAccountCategories: updateGlAccountCategory,
  patchGlAccountCategoryOrganizationGlAccountCategories: patchGlAccountCategory,
  deleteGlAccountCategoryOrganizationGlAccountCategories: deleteGlAccountCategory,
  listGlAccountCategoriesOrganizationGlAccountCategories: listGlAccountCategories,
  filterGlAccountCategoriesOrganizationGlAccountCategories: filterGlAccountCategories,
  searchGlAccountCategoriesOrganizationGlAccountCategories: searchGlAccountCategories,
  batchCreateGlAccountCategoriesOrganizationGlAccountCategories: batchCreateGlAccountCategories,
  batchGetGlAccountCategoriesOrganizationGlAccountCategories: batchGetGlAccountCategories,
  batchUpdateGlAccountCategoriesOrganizationGlAccountCategories: batchUpdateGlAccountCategories,
  batchPatchGlAccountCategoriesOrganizationGlAccountCategories: batchPatchGlAccountCategories,
  batchDeleteGlAccountCategoriesOrganizationGlAccountCategories: batchDeleteGlAccountCategories,
  activateGlAccountCategoriesOrganizationGlAccountCategories: activateGlAccountCategories,
  activateGlAccountCategoryOrganizationGlAccountCategories: activateGlAccountCategory,
  deactivateGlAccountCategoriesOrganizationGlAccountCategories: deactivateGlAccountCategories,
  deactivateGlAccountCategoryOrganizationGlAccountCategories: deactivateGlAccountCategory,
} as const;
