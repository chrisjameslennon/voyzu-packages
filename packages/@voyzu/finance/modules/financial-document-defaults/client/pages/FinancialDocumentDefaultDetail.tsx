...
import { CompanySettingsTitleBadges, getStatusSemanticColor, type DetailBackSource } from "../../../common/client/index";
import { AssignTarget } from "../../domain/operation-policy";
import type { BankCashAccountResponseDto } from "../../../bank-cash-accounts/types/index";
import type { FinancialDocumentDefaultPatchRequestDto, FinancialDocumentDefaultResponseDto } from "../../types/index";
