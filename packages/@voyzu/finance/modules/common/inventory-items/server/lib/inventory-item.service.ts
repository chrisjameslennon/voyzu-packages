...
import { ChangeCode, Deactivate, Delete } from "@voyzu/finance/common/inventory-items/domain/operation-policy";
import type { InventoryItemBatchPatchRequestDto, InventoryItemBatchUpdateRequestDto, InventoryItemCreateRequestDto, InventoryItemPatchRequestDto, InventoryItemResponseDto, InventoryItemUpdateRequestDto } from "@voyzu/finance/types/modules/inventory-items";
