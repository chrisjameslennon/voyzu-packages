import { CodeChange, CodeChangeAvailability, Deactivation, Deletion, type LinkedReference, type OperationBlocker } from "@voyzu/finance/common/domain/operation-policy";
