...
import { CompanySettingsTitleBadges, getHasPostingsColor, getStatusSemanticColor } from "@voyzu/finance/common/client";
import { ChangeCodeAvailability, ChangeValueNameAvailability, Deactivate, Delete, DeleteValue } from "@voyzu/finance/common/dimensions/domain/operation-policy";
import type { DimensionPatchRequestDto, DimensionResponseDto, DimensionValueCreateRequestDto, DimensionValuePatchRequestDto, DimensionValueResponseDto, DimensionValueStatus } from "@voyzu/finance/types/modules/dimensions";
