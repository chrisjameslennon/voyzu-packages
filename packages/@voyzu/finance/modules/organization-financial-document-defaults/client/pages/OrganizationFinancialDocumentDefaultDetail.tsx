...
import { getStatusSemanticColor, StandardSettingsReadOnlyAlert, type DetailBackSource } from "@voyzu/finance/common/client";
import { AssignTarget } from "@voyzu/finance/common/financial-document-defaults/domain/operation-policy";
import type { BankCashAccountResponseDto } from "@voyzu/finance/types/modules/bank-cash-accounts";
import type { FinancialDocumentDefaultPatchRequestDto, FinancialDocumentDefaultResponseDto } from "@voyzu/finance/types/modules/financial-document-defaults";
