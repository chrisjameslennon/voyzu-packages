...
export const apiDefinitions = {
  list: {
    ...
    loadHandler: () => import("./server/api/inventory-control-account.http.handlers").then((module) => module.handleListInventoryControlAccounts),
  ...
  patch: {
    ...
    loadHandler: () => import("./server/api/inventory-control-account.http.handlers").then((module) => module.handlePatchInventoryControlAccount),
