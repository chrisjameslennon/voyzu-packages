...
export const apiDefinitions = {
  list: {
    ...
    loadHandler: () => import("./server/api/financial-document-type.http.handlers").then((module) => module.handleList),
  ...
  filter: {
    ...
    loadHandler: () => import("./server/api/financial-document-type.http.handlers").then((module) => module.handleFilter),
  ...
  search: {
    ...
    loadHandler: () => import("./server/api/financial-document-type.http.handlers").then((module) => module.handleSearch),
  ...
  batchGet: {
    ...
    loadHandler: () => import("./server/api/financial-document-type.http.handlers").then((module) => module.handleBatchGet),
  ...
  get: {
    ...
    loadHandler: () => import("./server/api/financial-document-type.http.handlers").then((module) => module.handleGet),
