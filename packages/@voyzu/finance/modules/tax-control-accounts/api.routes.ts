...
export const apiDefinitions = {
  list: {
    ...
    loadHandler: () => import("./server/api/tax-control-account.http.handlers").then((module) => module.handleListTaxControlAccounts),
  ...
  patch: {
    ...
    loadHandler: () => import("./server/api/tax-control-account.http.handlers").then((module) => module.handlePatchTaxControlAccount),
