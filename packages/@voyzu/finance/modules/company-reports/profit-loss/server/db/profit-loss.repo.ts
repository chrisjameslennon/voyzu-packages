...
import type { ProfitLossLineDto, ProfitLossSection } from "@voyzu/finance/types/modules/company-reports";
  ...
  async getDimensionSourceLines(
    ...
    const { rows } = await this.db.query(
      `WITH line_dimensions AS (
       ...
       LEFT JOIN gl_account_category gac ON gac.finance_organization_id = ga.finance_organization_id AND gac.id = ga.account_category_id
