...
import { CompanySettingsTitleBadges, getHasPostingsColor, getStatusSemanticColor, type DetailBackSource } from "../../common/client/index";
import { ChangeCodeAvailability, ChangeTypeAvailability, Deactivate, Delete, UpdateGLAccount } from "../domain/operation-policy";
import type { BankCashAccountPatchRequestDto, BankCashAccountResponseDto } from "../types/index";
...
import { BankCashAccountDetailsForm } from "./index";
...
export function BankCashAccountDetail({
  account,
  glAccounts,
