...
export const apiDefinitions = {
  list: {
    ...
    loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleList),
  ...
  filter: {
    method: "POST", path: "/finance/[companyCode]/bank-cash-accounts/filter", loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleFilter),
  ...
  search: {
    method: "GET", path: "/finance/[companyCode]/bank-cash-accounts/search", loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleSearch),
  ...
  batchGet: {
    method: "POST", path: "/finance/[companyCode]/bank-cash-accounts/batch/get", loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleBatchGet),
  ...
  batchCreate: {
    method: "POST", path: "/finance/[companyCode]/bank-cash-accounts/batch/create", loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleBatchCreate),
  ...
  batchUpdate: {
    method: "PUT", path: "/finance/[companyCode]/bank-cash-accounts/batch", loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleBatchUpdate),
  ...
  batchPatch: {
    method: "PATCH", path: "/finance/[companyCode]/bank-cash-accounts/batch", loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleBatchPatch),
  ...
  batchDelete: {
    method: "DELETE", path: "/finance/[companyCode]/bank-cash-accounts/batch", loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleBatchDelete),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } } }, contentType: "application/json", body: CodesRequestDto },
  ...
  create: {
    method: "POST",
    path: "/finance/[companyCode]/bank-cash-accounts",
    loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleCreate),
  ...
  get: {
    ...
    loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleGet),
  ...
  patch: {
    method: "PATCH",
    path: "/finance/[companyCode]/bank-cash-accounts/[code]",
    loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handlePatch),
  ...
  update: {
    method: "PUT", path: "/finance/[companyCode]/bank-cash-accounts/[code]", loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleUpdate),
  ...
  delete: {
    method: "DELETE",
    path: "/finance/[companyCode]/bank-cash-accounts/[code]",
    loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleDelete),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } }, code: { description: "Business code of the requested record.", schema: { type: "string" } } } },
    summary: "Delete",
  ...
  activate: {
    method: "POST", path: "/finance/[companyCode]/bank-cash-accounts/[code]/activate", loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleActivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } }, code: { description: "Business code of the requested record.", schema: { type: "string" } } } },
    summary: "Activate",
  ...
  deactivate: {
    method: "POST", path: "/finance/[companyCode]/bank-cash-accounts/[code]/deactivate", loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleDeactivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } }, code: { description: "Business code of the requested record.", schema: { type: "string" } } } },
    summary: "Deactivate",
  ...
  batchActivate: {
    ...
    loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleBatchActivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } } }, contentType: "application/json", body: CodesRequestDto },
  ...
  batchDeactivate: {
    ...
    loadHandler: () => import("./server/api/bank-cash-account.http.handlers").then((module) => module.handleBatchDeactivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } } }, contentType: "application/json", body: CodesRequestDto },
