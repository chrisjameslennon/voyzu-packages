...
export async function InventoryItemPostingProfileAssignmentsPage() {
  ...
  return <PostingProfileAssignmentsView data={await listPostingProfileAssignments(companyId)} httpApiPath={`/api/finance/${encodeURIComponent(companyCode)}/inventory/item-posting-profile-assignments`} />;
}
