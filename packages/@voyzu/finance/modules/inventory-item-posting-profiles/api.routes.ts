...
export const apiDefinitions = {
  list: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleList),
  ...
  filter: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleFilter),
  ...
  search: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleSearch),
  ...
  batchGet: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleBatchGet),
  ...
  batchCreate: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleBatchCreate),
  ...
  batchUpdate: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleBatchUpdate),
  ...
  batchPatch: {
    method: "PATCH",
    path: "/finance/[companyCode]/inventory/item-posting-profiles/batch",
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleBatchPatch),
  ...
  batchDelete: {
    method: "DELETE",
    path: "/finance/[companyCode]/inventory/item-posting-profiles/batch",
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleBatchDelete),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } } }, contentType: "application/json", body: CodesRequestDto },
  ...
  create: {
    method: "POST",
    path: "/finance/[companyCode]/inventory/item-posting-profiles",
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleCreate),
  ...
  get: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleGet),
  ...
  update: {
    method: "PUT",
    path: "/finance/[companyCode]/inventory/item-posting-profiles/[code]",
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleUpdate),
  ...
  patch: {
    method: "PATCH",
    path: "/finance/[companyCode]/inventory/item-posting-profiles/[code]",
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handlePatch),
  ...
  delete: {
    method: "DELETE",
    path: "/finance/[companyCode]/inventory/item-posting-profiles/[code]",
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleDelete),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } }, code: { description: "Business code of the requested record.", schema: { type: "string" } } } },
    summary: "Delete",
  ...
  activate: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleActivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } }, code: { description: "Business code of the requested record.", schema: { type: "string" } } } },
    summary: "Activate",
  ...
  deactivate: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleDeactivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } }, code: { description: "Business code of the requested record.", schema: { type: "string" } } } },
    summary: "Deactivate",
  ...
  batchActivate: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleBatchActivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } } }, contentType: "application/json", body: CodesRequestDto },
  ...
  batchDeactivate: {
    ...
    loadHandler: () => import("./server/api/item-posting-profile.http.handlers").then((module) => module.handleBatchDeactivate),
    request: { path: { companyCode: { description: "Company code that identifies the company scope for this finance API call.", schema: { type: "string" } } }, contentType: "application/json", body: CodesRequestDto },
