...
import { ItemPostingProfileDetailsForm } from "./index";

import type { GlAccountResponseDto } from "../../gl-accounts/types/index";
import type { ItemPostingProfilePatchRequestDto, ItemPostingProfileResponseDto } from "../types/index";
...
export function InventoryItemPostingProfileDetail({
  profile,
  glAccounts,
