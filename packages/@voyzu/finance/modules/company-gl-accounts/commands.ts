...
export const commands = {
  createGlAccountCompanyGlAccounts: createGlAccount,
  getGlAccountCompanyGlAccounts: getGlAccount,
  updateGlAccountCompanyGlAccounts: updateGlAccount,
  patchGlAccountCompanyGlAccounts: patchGlAccount,
  deleteGlAccountCompanyGlAccounts: deleteGlAccount,
  listGlAccountsCompanyGlAccounts: listGlAccounts,
  filterGlAccountsCompanyGlAccounts: filterGlAccounts,
  searchGlAccountsCompanyGlAccounts: searchGlAccounts,
  batchCreateGlAccountsCompanyGlAccounts: batchCreateGlAccounts,
  batchGetGlAccountsCompanyGlAccounts: batchGetGlAccounts,
  batchUpdateGlAccountsCompanyGlAccounts: batchUpdateGlAccounts,
  batchPatchGlAccountsCompanyGlAccounts: batchPatchGlAccounts,
  batchDeleteGlAccountsCompanyGlAccounts: batchDeleteGlAccounts,
  activateGlAccountsCompanyGlAccounts: activateGlAccounts,
  activateGlAccountCompanyGlAccounts: activateGlAccount,
  deactivateGlAccountsCompanyGlAccounts: deactivateGlAccounts,
  deactivateGlAccountCompanyGlAccounts: deactivateGlAccount,
} as const;
