...
import type { ArReceiptRequestDto } from "@voyzu/finance/types/modules/financial-document-processing-engine";
import { processArReceipt } from "@voyzu/finance/financial-document-processing-engine/server";
