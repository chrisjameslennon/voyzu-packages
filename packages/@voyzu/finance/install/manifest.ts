export const financeInstall = {
  sql: [
    ...
    "./install/db/objects/table.finance_inventory_activity.create.sql",
    ...
    "./install/db/objects/table.finance_inventory_processing_rule.create.sql",
  ...
  seedSql: [
    ...
    "./install/db/seed/finance-inventory-processing-rule.seed.sql",
