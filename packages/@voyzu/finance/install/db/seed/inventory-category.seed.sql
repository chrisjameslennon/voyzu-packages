...
INSERT INTO inventory_category (finance_organization_id, code, name, description, posting_profile_id, status, creation_actor_type, updated_actor_type)
...
JOIN item_posting_profile p ON p.finance_organization_id = fc.id AND p.code = s.posting_profile_code
