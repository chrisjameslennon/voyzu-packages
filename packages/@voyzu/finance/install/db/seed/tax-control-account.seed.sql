...
INSERT INTO tax_control_account (finance_company_id, code, ledger, name, description, tax_family_code, status, gl_account_id, creation_actor_type, updated_actor_type)
