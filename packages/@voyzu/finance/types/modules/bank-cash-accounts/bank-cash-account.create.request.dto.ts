...
import { BusinessCode40, NonBlankText, PositiveId, TrimmedText100, TrimmedText50 } from "@voyzu/finance/types/constraints";

export const BankCashAccountCreateRequestDto = StrictObject({
  code: BusinessCode40,
...
export type BankCashAccountCreateRequestDto = Type.Static<typeof BankCashAccountCreateRequestDto>;
