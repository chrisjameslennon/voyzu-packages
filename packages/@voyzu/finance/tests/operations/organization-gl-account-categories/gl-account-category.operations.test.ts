...
import type { GlAccountCategoryCreateRequestDto } from "@voyzu/finance/types/modules/gl-account-categories/gl-account-category.create.request.dto";
import type { GlAccountCategoryPatchRequestDto } from "@voyzu/finance/types/modules/gl-account-categories/gl-account-category.patch.request.dto";
import type { GlAccountCategoryResponseDto } from "@voyzu/finance/types/modules/gl-account-categories/gl-account-category.response.dto";
import type { GlAccountCategoryUpdateRequestDto } from "@voyzu/finance/types/modules/gl-account-categories/gl-account-category.update.request.dto";

import { getPool } from "@voyzu/capability/db";
import { createGlAccount, deleteGlAccount } from "../../../modules/organization-gl-accounts/operations";
import {
...
} from "../../../modules/organization-gl-account-categories/operations";
