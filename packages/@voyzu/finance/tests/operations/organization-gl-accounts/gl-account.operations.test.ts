...
import type { GlAccountCreateRequestDto } from "@voyzu/finance/types/modules/gl-accounts/gl-account.create.request.dto";
import type { GlAccountPatchRequestDto } from "@voyzu/finance/types/modules/gl-accounts/gl-account.patch.request.dto";
import type { GlAccountResponseDto } from "@voyzu/finance/types/modules/gl-accounts/gl-account.response.dto";
import type { GlAccountUpdateRequestDto } from "@voyzu/finance/types/modules/gl-accounts/gl-account.update.request.dto";
...
} from "../../../modules/organization-gl-accounts/operations";
import { listGlAccountCategories } from "../../../modules/organization-gl-account-categories/operations";
