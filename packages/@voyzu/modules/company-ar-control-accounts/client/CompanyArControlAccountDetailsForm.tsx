...
interface CompanyArControlAccountDetailsFormProps {
...
export function CompanyArControlAccountDetailsForm({ account, glAccounts, glAccountId, disabled, onGlAccountChange }: CompanyArControlAccountDetailsFormProps) {
