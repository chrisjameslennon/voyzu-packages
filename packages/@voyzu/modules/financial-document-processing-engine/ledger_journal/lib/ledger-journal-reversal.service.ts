...
} from "@voyzu/types/modules/financial-document-processing-engine/ledger-journal-reversal.response.dto";
import type {
  LedgerJournalJournalLineDto,
  LedgerJournalPostingDetailsDto,
} from "@voyzu/types/modules/financial-document-processing-engine/ledger-journal.response.dto";
