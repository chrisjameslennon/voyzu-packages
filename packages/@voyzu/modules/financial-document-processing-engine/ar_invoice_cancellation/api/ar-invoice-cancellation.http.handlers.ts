...
import type { ArInvoiceCancellationPostingResponseDto } from "@voyzu/types/modules/financial-document-processing-engine/ar-invoice-cancellation.response.dto";
