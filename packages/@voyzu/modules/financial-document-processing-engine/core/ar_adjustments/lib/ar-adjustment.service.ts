...
import type { ArCreditNoteRequestDto } from "@voyzu/types/modules/financial-document-processing-engine/ar-credit-note.request.dto";
...
import type { ArRefundRequestDto } from "@voyzu/types/modules/financial-document-processing-engine/ar-refund.request.dto";
...
} from "@voyzu/types/modules/financial-document-processing-engine/ar-adjustment.response.dto";
import type { ArInvoiceDetailedTaxComponentDto } from "@voyzu/types/modules/financial-document-processing-engine/ar-invoice.response.dto";
