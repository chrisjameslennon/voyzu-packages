...
import type {
  ...
  TaxRefundRequestDto,
} from "@voyzu/types/modules/financial-document-processing-engine/tax-processing.request.dto";
import type {
  TaxProcessingDetailedDocumentDto,
  TaxProcessingPostingResponseDto,
  TaxProcessingTaxLedgerDetailDto,
} from "@voyzu/types/modules/financial-document-processing-engine/tax-processing.response.dto";
