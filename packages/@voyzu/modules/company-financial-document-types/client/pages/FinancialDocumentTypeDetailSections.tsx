...
import { getDrCrColor } from "@voyzu/modules/common/client";
import { detailLinkWithBackContext } from "@voyzu/modules/common/client";
...
} from "@voyzu/types/modules/financial-document-types";
import {
  Badge,
  Input,
