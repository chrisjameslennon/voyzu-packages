...
interface OrganizationArControlAccountDetailsFormProps {
...
export function OrganizationArControlAccountDetailsForm({ account, glAccounts, glAccountId, disabled, onGlAccountChange }: OrganizationArControlAccountDetailsFormProps) {
    ...
    <section className={detailStyles.card}>
      ...
      <div className={detailStyles.formGrid}>
        ...
        <label className={detailStyles.fieldGroup}>
          <span className={`${typography.fieldLabel} ${detailStyles.inlineGroup}`}>GL Account <Badge variant="soft" size="x-small" color="neutral">ASSET</Badge></span>
