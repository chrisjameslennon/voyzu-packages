...
import { getStatusSemanticColor, StandardSettingsReadOnlyAlert, type DetailBackSource } from "@voyzu/modules/common/client";
import { AssignTarget } from "@voyzu/modules/common/financial-document-defaults/domain/operation-policy";
import type { BankCashAccountResponseDto } from "@voyzu/types/modules/bank-cash-accounts";
import type { FinancialDocumentDefaultPatchRequestDto, FinancialDocumentDefaultResponseDto } from "@voyzu/types/modules/financial-document-defaults";
