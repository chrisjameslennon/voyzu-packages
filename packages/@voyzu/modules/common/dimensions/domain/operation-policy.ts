import { CodeChange, CodeChangeAvailability, Deactivation, Deletion, type LinkedReference, type OperationBlocker } from "@voyzu/modules/common/domain/operation-policy";
