...
import { AssignGLAccount, ConfigurePostingAccounts, Deactivate, Delete } from "@voyzu/modules/common/inventory-item-posting-profiles/domain/operation-policy";
...
import type { ItemPostingProfileBatchPatchRequestDto } from "@voyzu/types/modules/inventory-item-posting-profiles";
import type { ItemPostingProfileBatchUpdateRequestDto } from "@voyzu/types/modules/inventory-item-posting-profiles";
import type { ItemPostingProfileCreateRequestDto } from "@voyzu/types/modules/inventory-item-posting-profiles";
import type { ItemPostingProfilePatchRequestDto } from "@voyzu/types/modules/inventory-item-posting-profiles";
import type { ItemPostingProfileResponseDto } from "@voyzu/types/modules/inventory-item-posting-profiles";
import type { ItemPostingProfileUpdateRequestDto } from "@voyzu/types/modules/inventory-item-posting-profiles";
