...
import type { GlAccountCreateRequestDto } from "@voyzu/types/modules/gl-accounts/gl-account.create.request.dto";
import type { GlAccountPatchRequestDto } from "@voyzu/types/modules/gl-accounts/gl-account.patch.request.dto";
import type { GlAccountResponseDto } from "@voyzu/types/modules/gl-accounts/gl-account.response.dto";
import type { GlAccountUpdateRequestDto } from "@voyzu/types/modules/gl-accounts/gl-account.update.request.dto";
