...
import { CompanySettingsTitleBadges, getHasPostingsColor, getStatusSemanticColor } from "@voyzu/modules/common/client";
import { ChangeCodeAvailability, ChangeValueNameAvailability, Deactivate, Delete, DeleteValue } from "@voyzu/modules/common/dimensions/domain/operation-policy";
import type { DimensionPatchRequestDto, DimensionResponseDto, DimensionValueCreateRequestDto, DimensionValuePatchRequestDto, DimensionValueResponseDto, DimensionValueStatus } from "@voyzu/types/modules/dimensions";
