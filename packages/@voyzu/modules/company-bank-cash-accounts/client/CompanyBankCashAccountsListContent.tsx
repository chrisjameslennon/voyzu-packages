...
import { Deactivate, Delete } from "@voyzu/modules/common/bank-cash-accounts/domain/operation-policy";
import { AddBankCashAccountModal } from "@voyzu/modules/common/bank-cash-accounts/client";
import { useEffect, useMemo, useState } from "react";
import { useRouter } from "next/navigation";

import type { BankCashAccountCreateRequestDto, BankCashAccountResponseDto } from "@voyzu/types/modules/bank-cash-accounts";
...
interface CompanyBankCashAccountsListContentProps {
...
export function CompanyBankCashAccountsListContent({
  accounts,
  glAccounts,
  ...
  return (
    <>
      <div className={layoutStyles.slotActions}>
        <Button variant="primary" icon="add" className={layoutStyles.slotPrimaryAction} disabled={readOnly} onClick={() => setIsAddOpen(true)}>Add Bank / Cash Account</Button>
      </div>
