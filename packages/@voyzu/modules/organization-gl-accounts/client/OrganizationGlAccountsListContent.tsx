...
import { getGlAccountTypeColor, getStatusSemanticColor } from "@voyzu/modules/common/client";
import { Deactivate, Delete } from "@voyzu/modules/common/gl-accounts/domain/operation-policy";
import { AddGlAccountModal, GL_ACCOUNT_CODE_PATTERN, GL_ACCOUNT_TYPE_OPTIONS } from "../../common/gl-accounts/client";
import { useEffect, useMemo, useState } from "react";
import { useRouter } from "next/navigation";

import type { GlAccountCategoryResponseDto } from "@voyzu/types/modules/gl-account-categories";
import type { GlAccountCreateRequestDto, GlAccountResponseDto } from "@voyzu/types/modules/gl-accounts";
import {
  Badge,
  Breadcrumbs,
  Button,
