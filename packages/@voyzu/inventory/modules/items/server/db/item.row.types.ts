...
export interface ItemRow {
  ...
  unit: string; item_type: ItemType; quantity_tracked: boolean; item_posting_code_id: number | null;
...
export interface ItemComponentRow {
  component_item_id: number; sku: string; name: string; quantity: number; unit: string; item_type: ItemType;
}
