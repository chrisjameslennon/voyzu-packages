...
import { createInventoryItem } from "../../../modules/items/commands";
import { getInventoryReport } from "../../../modules/reports/commands";
import type { InventoryReportKey } from "../../../modules/reports/types/report.types";
import { receiveInventoryStock } from "../../../modules/stock/commands";
import {
...
before(async () => {
  ...
  await receiveInventoryStock(organization.id, {
    ...
    lines: [{ itemId: item.id, quantity: 3, reasonCode: "PURCHASE" }],
  });
});
