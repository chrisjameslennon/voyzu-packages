...
INSERT INTO inventory_control_account (company_id, code, ledger, name, description, status, gl_account_id, creation_actor_type, updated_actor_type)
SELECT c.id, s.code, s.ledger, s.name, s.description, s.status, ga.id, 'SYSTEM', 'SYSTEM'
FROM seed s
