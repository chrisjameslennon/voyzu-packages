...
CREATE TABLE IF NOT EXISTS dimension_value (
    ...
    CONSTRAINT fk_dimension_value_company FOREIGN KEY (company_id) REFERENCES company(id),
    CONSTRAINT fk_dimension_value_dimension FOREIGN KEY (company_id, dimension_id) REFERENCES dimension(company_id, id) ON DELETE CASCADE,
    CONSTRAINT dimension_value_dimension_id_id_unique UNIQUE (company_id, dimension_id, id),
...
CREATE UNIQUE INDEX IF NOT EXISTS dimension_value_name_unique
    ON dimension_value (company_id, dimension_id, lower(name));
