...
import { getGlAccountTypeColor, getStatusSemanticColor } from "@voyzu/core/common/client";
import { Deactivate, Delete } from "@voyzu/core/common/gl-accounts/domain/operation-policy";
...
import type { GlAccountCreateRequestDto, GlAccountResponseDto } from "@voyzu/core/types/modules/gl-accounts";
import {
  Badge,
  Breadcrumbs,
  Button,
