...
import { CompanyArControlAccountSummaryPanels } from "../../client/CompanyArControlAccountSummaryPanels";
...
export async function CompanyArControlAccountsListPage() {
  ...
  return (
    <div className={`${layoutStyles.listView} ${layoutStyles.compactMobilePadding}`}>
      ...
      <div className={layoutStyles.slotBody}>
        <CompanyArControlAccountSummaryPanels accounts={accounts} basePath="/finance/settings/control-accounts/ar" />
      </div>
    </div>
  );
}
