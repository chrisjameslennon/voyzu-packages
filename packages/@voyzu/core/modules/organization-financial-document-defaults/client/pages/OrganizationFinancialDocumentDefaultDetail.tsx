...
import { getStatusSemanticColor, StandardSettingsReadOnlyAlert, type DetailBackSource } from "@voyzu/core/common/client";
import { AssignTarget } from "@voyzu/core/common/financial-document-defaults/domain/operation-policy";
import type { BankCashAccountResponseDto } from "@voyzu/core/types/modules/bank-cash-accounts";
import type { FinancialDocumentDefaultPatchRequestDto, FinancialDocumentDefaultResponseDto } from "@voyzu/core/types/modules/financial-document-defaults";
