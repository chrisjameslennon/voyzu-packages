...
function validators() {
  ...
  } satisfies { [K in keyof ArCounterpartyResponseDto]-?: FieldValidator<ArCounterpartyResponseDto[K]> };
}

export function validateResponse(input: ArCounterpartyResponseDto): string[] {
