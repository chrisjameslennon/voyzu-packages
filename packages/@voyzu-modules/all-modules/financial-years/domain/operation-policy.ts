import type { FinancialYearStatus } from "@voyzu-modules/types/modules/financial-years";
import { CodeChange, Deletion, type OperationBlocker } from "@voyzu-modules/all-modules/common/domain/operation-policy";
