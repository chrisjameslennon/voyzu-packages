import type { Ledger, Status } from "@voyzu/types/modules";
import type { FinancialDocumentTypeCreateRequestDto } from "@voyzu-modules/types/modules/financial-document-types";
import type { FinancialDocumentTypePatchRequestDto } from "@voyzu-modules/types/modules/financial-document-types";
import type { FinancialDocumentTypeResponseDto } from "@voyzu-modules/types/modules/financial-document-types";
import type { FinancialDocumentTypeUpdateRequestDto } from "@voyzu-modules/types/modules/financial-document-types";
