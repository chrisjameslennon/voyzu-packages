...
import type { GlAccountCategoryCreateRequestDto } from "@voyzu-modules/types/modules/gl-account-categories/gl-account-category.create.request.dto";
import type { GlAccountCategoryPatchRequestDto } from "@voyzu-modules/types/modules/gl-account-categories/gl-account-category.patch.request.dto";
import type { GlAccountCategoryResponseDto } from "@voyzu-modules/types/modules/gl-account-categories/gl-account-category.response.dto";
import type { GlAccountCategoryUpdateRequestDto } from "@voyzu-modules/types/modules/gl-account-categories/gl-account-category.update.request.dto";
