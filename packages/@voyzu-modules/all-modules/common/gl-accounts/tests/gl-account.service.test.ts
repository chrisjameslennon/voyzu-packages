...
import type { GlAccountCreateRequestDto } from "@voyzu-modules/types/modules/gl-accounts/gl-account.create.request.dto";
import type { GlAccountPatchRequestDto } from "@voyzu-modules/types/modules/gl-accounts/gl-account.patch.request.dto";
import type { GlAccountResponseDto } from "@voyzu-modules/types/modules/gl-accounts/gl-account.response.dto";
import type { GlAccountUpdateRequestDto } from "@voyzu-modules/types/modules/gl-accounts/gl-account.update.request.dto";
