...
import type { FinancialDocumentDefaultTargetType } from "@voyzu-modules/types/modules/financial-document-defaults";
import type { OperationBlocker } from "@voyzu-modules/all-modules/common/domain/operation-policy";
