...
import type { InventoryItemBatchPatchRequestDto, InventoryItemBatchUpdateRequestDto } from "@voyzu-modules/types/modules/inventory-items";
...
import type { InventoryItemUpdateRequestDto } from "@voyzu-modules/types/modules/inventory-items";
import { getDb } from "@voyzu/capability/db";
import { BusinessRuleError, DataError, NotFoundError } from "@voyzu/capability/errors";
import { ChangeCode, Deactivate, Delete } from "@voyzu-modules/all-modules/common/inventory-items/domain/operation-policy";
