import { CodeChange, CodeChangeAvailability, Deactivation, Deletion, type LinkedReference, type OperationBlocker } from "@voyzu-modules/all-modules/common/domain/operation-policy";
