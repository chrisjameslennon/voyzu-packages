...
import type { DimensionCreateRequestDto } from "@voyzu-modules/types/modules/dimensions";
import type { DimensionUpdateRequestDto } from "@voyzu-modules/types/modules/dimensions";
import type { DimensionPatchRequestDto } from "@voyzu-modules/types/modules/dimensions";
import type { DimensionBatchPatchRequestDto, DimensionBatchUpdateRequestDto } from "@voyzu-modules/types/modules/dimensions";
import type { DimensionResponseDto } from "@voyzu-modules/types/modules/dimensions";
import type { DimensionValueCreateRequestDto } from "@voyzu-modules/types/modules/dimensions";
import type { DimensionValuePatchRequestDto } from "@voyzu-modules/types/modules/dimensions";
import type { DimensionValueResponseDto } from "@voyzu-modules/types/modules/dimensions";
...
import { ChangeCode, ChangeValueName, Deactivate, Delete, DeleteValue } from "@voyzu-modules/all-modules/common/dimensions/domain/operation-policy";
