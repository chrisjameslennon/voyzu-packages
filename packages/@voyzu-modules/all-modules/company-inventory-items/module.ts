import { handleActivate as handleActivateInventoryItem, handleBatchActivate as handleBatchActivateInventoryItems, handleBatchCreate as handleBatchCreateInventoryItems, handleBatchDeactivate as handleBatchDeactivateInventoryItems, handleBatchDelete as handleBatchDeleteInventoryItems, handleBatchGet as handleBatchGetInventoryItems, handleBatchPatch as handleBatchPatchInventoryItems, handleBatchUpdate as handleBatchUpdateInventoryItems, handleCreate as handleCreateInventoryItem, handleDeactivate as handleDeactivateInventoryItem, handleDelete as handleDeleteInventoryItem, handleFilter as handleFilterInventoryItems, handleGet as handleGetInventoryItem, handleList as handleListInventoryItems, handlePatch as handlePatchInventoryItem, handleSearch as handleSearchInventoryItems, handleUpdate as handleUpdateInventoryItem } from "@voyzu-modules/all-modules/common/inventory-items/server";
import { arrayOf, dtoRef } from "@voyzu/types/api";

export const companyInventoryItemsModule = {
  id: "voyzu.company-inventory-items",
