import { handleGetArCounterparty, handleListArCounterparties } from "@voyzu-modules/all-modules/ar-subledger-counterparties/server";
import { arrayOf, dtoRef } from "@voyzu/types/api";

export const arSubledgerCounterpartiesModule = {
  id: "voyzu.ar-subledger-counterparties",
  name: "AR Counterparties",
  pageRoutes: {
    list: {
