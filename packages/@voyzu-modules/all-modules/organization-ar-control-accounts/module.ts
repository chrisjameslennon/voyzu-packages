import { handleGet as handleControlAccountsGet, handleListAr as handleArControlAccountsList, handlePatch as handleControlAccountsPatch } from "@voyzu-modules/all-modules/common/control-accounts/server";
import { arrayOf, dtoRef } from "@voyzu/types/api";

export const organizationArControlAccountsModule = {
  id: "voyzu.organization-ar-control-accounts",
