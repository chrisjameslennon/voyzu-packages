...
import type { GlAccountCategoryPatchRequestDto, GlAccountCategoryResponseDto } from "@voyzu-modules/types/modules/gl-account-categories";
...
interface CompanyGlAccountCategoryDetailProps {
      ...
      <header className={layoutStyles.detailHeader}>
        ...
        <div className={layoutStyles.slotActions}>
          <div className={detailStyles.headerActions}>
            ...
            <Button variant="primary" icon="save" disabled={saving || readOnly} onClick={() => { void save(); }}>
              {saving ? "Saving..." : "Save"}
            </Button>
          </div>
        </div>
