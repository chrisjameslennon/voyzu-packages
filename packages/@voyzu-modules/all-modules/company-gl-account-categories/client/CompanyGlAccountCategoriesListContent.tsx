...
export function CompanyGlAccountCategoriesListContent({
  categories,
  ...
  const exportItems = useMemo<DropdownMenuItem[]>(() => [
    {
      ...
      onSelect: () => { void handleExport(selectedCategories, "reporting_categories_selected"); },
    },
    {
      value: "current-view",
      ...
      onSelect: () => { void handleExport(filtered, "reporting_categories_current_view"); },
    },
    {
      value: "full-dataset",
      ...
      onSelect: () => { void handleExport(data, "reporting_categories_full_dataset"); },
    },
      ...
      <div className={layoutStyles.listBody}>
        <div className={layoutStyles.slotBody}>
          <DataTable<GlAccountCategoryResponseDto, number>
            ...
            onRowClick={(category) => router.push(`${basePath}/${encodeURIComponent(category.code)}`)}
