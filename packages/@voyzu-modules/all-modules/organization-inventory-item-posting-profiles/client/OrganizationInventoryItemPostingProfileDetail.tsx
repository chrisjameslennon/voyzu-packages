...
import { AssignGLAccount, Deactivate, Delete, PostingAccountEnabled, PostingAccountRequired } from "@voyzu-modules/all-modules/common/inventory-item-posting-profiles/domain/operation-policy";
