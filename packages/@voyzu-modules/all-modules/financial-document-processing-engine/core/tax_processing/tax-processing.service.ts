...
import type {
  ...
  TaxRefundRequestDto,
} from "@voyzu-modules/types/modules/financial-document-processing-engine/tax-processing.request.dto";
import type {
  TaxProcessingDetailedDocumentDto,
  TaxProcessingPostingResponseDto,
  TaxProcessingTaxLedgerDetailDto,
} from "@voyzu-modules/types/modules/financial-document-processing-engine/tax-processing.response.dto";
