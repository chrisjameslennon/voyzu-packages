...
import type { ArCreditNoteRequestDto } from "@voyzu-modules/types/modules/financial-document-processing-engine/ar-credit-note.request.dto";
import type { ArOpeningBalanceRequestDto } from "@voyzu-modules/types/modules/financial-document-processing-engine/ar-opening-balance.request.dto";
import type { ArRefundRequestDto } from "@voyzu-modules/types/modules/financial-document-processing-engine/ar-refund.request.dto";
import type { ArWriteOffRequestDto } from "@voyzu-modules/types/modules/financial-document-processing-engine/ar-write-off.request.dto";
import type {
...
} from "@voyzu-modules/types/modules/financial-document-processing-engine/ar-adjustment.response.dto";
import type { ArInvoiceDetailedTaxComponentDto } from "@voyzu-modules/types/modules/financial-document-processing-engine/ar-invoice.response.dto";
import type { BankCashJournalDetailsDto } from "@voyzu-modules/types/modules/financial-document-processing-engine/bank-cash-details.dto";
