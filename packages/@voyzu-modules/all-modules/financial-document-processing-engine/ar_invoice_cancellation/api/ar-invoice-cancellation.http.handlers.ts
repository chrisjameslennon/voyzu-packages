...
import type { ArInvoiceCancellationPostingResponseDto } from "@voyzu-modules/types/modules/financial-document-processing-engine/ar-invoice-cancellation.response.dto";
