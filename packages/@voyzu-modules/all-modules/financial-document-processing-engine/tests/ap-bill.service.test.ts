...
import type { ApBillRequestDto } from "@voyzu-modules/types/modules/financial-document-processing-engine/ap-bill.request.dto";
import { getPool } from "@voyzu/capability/db";
import { processApBill } from "@voyzu-modules/all-modules/financial-document-processing-engine/server";
import type { ApBillDataValidationContext } from "@voyzu-modules/all-modules/financial-document-processing-engine/server";
import {
  validateApBillData as validateData,
  validateApBillRequest as validateRequest,
} from "@voyzu-modules/all-modules/financial-document-processing-engine/server";
...
function validData(): ApBillDataValidationContext {
  ...
  return {
    ...
    counterparty: { id: 10, company_id: 1, code: "SUPP_TEST", name: "Supplier Test", status: "ACTIVE", country_code: "NZ", tax_region_or_province: null, country_currency_code: "NZD" },
