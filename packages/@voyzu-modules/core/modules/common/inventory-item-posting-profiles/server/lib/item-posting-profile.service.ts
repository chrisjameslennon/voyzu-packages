...
import { AssignGLAccount, ConfigurePostingAccounts, Deactivate, Delete } from "@voyzu-modules/core/common/inventory-item-posting-profiles/domain/operation-policy";
...
import type { ItemPostingProfileBatchPatchRequestDto } from "@voyzu-modules/core/types/modules/inventory-item-posting-profiles";
import type { ItemPostingProfileBatchUpdateRequestDto } from "@voyzu-modules/core/types/modules/inventory-item-posting-profiles";
import type { ItemPostingProfileCreateRequestDto } from "@voyzu-modules/core/types/modules/inventory-item-posting-profiles";
import type { ItemPostingProfilePatchRequestDto } from "@voyzu-modules/core/types/modules/inventory-item-posting-profiles";
import type { ItemPostingProfileResponseDto } from "@voyzu-modules/core/types/modules/inventory-item-posting-profiles";
import type { ItemPostingProfileUpdateRequestDto } from "@voyzu-modules/core/types/modules/inventory-item-posting-profiles";
