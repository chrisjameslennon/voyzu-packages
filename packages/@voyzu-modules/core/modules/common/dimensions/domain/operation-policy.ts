import { CodeChange, CodeChangeAvailability, Deactivation, Deletion, type LinkedReference, type OperationBlocker } from "@voyzu-modules/core/common/domain/operation-policy";
