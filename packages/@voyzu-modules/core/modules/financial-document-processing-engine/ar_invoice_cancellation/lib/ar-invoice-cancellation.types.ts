import type { ArInvoiceCancellationDetailedDocumentDto } from "@voyzu-modules/core/types/modules/financial-document-processing-engine/ar-invoice-cancellation.response.dto";
