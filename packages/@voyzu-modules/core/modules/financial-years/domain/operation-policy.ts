import type { FinancialYearStatus } from "@voyzu-modules/core/types/modules/financial-years";
import { CodeChange, Deletion, type OperationBlocker } from "@voyzu-modules/core/common/domain/operation-policy";
