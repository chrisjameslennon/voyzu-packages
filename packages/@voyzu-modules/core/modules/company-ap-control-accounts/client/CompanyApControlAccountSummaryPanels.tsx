...
import { ControlAccountSummaryPanel } from "@voyzu-modules/core/common/control-accounts/client";
import type { ControlAccountSettingResponseDto } from "@voyzu-modules/core/types/modules/control-accounts";

import styles from "./control-account-summary-panels.module.css";

interface CompanyApControlAccountSummaryPanelsProps {
...
export function CompanyApControlAccountSummaryPanels({ accounts, basePath }: CompanyApControlAccountSummaryPanelsProps) {
