...
import { ChangeCodeAvailability, ChangeTypeAvailability, Deactivate, Delete, UpdateGLAccount } from "@voyzu-modules/core/common/bank-cash-accounts/domain/operation-policy";
import type { BankCashAccountPatchRequestDto, BankCashAccountResponseDto } from "@voyzu-modules/core/types/modules/bank-cash-accounts";
