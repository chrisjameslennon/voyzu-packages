...
import { CompanySettingsTitleBadges, getHasPostingsColor, getStatusSemanticColor } from "@voyzu-modules/core/common/client";
import { ChangeCodeAvailability, ChangeValueNameAvailability, Deactivate, Delete, DeleteValue } from "@voyzu-modules/core/common/dimensions/domain/operation-policy";
import type { DimensionPatchRequestDto, DimensionResponseDto, DimensionValueCreateRequestDto, DimensionValuePatchRequestDto, DimensionValueResponseDto, DimensionValueStatus } from "@voyzu-modules/core/types/modules/dimensions";
