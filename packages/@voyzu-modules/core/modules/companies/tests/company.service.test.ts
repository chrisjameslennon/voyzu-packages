...
import type { CompanyCreateRequestDto } from "@voyzu-modules/core/types/modules/companies/company.create.request.dto";
import type { CompanyPatchRequestDto } from "@voyzu-modules/core/types/modules/companies/company.patch.request.dto";
import type { CompanyResponseDto } from "@voyzu-modules/core/types/modules/companies/company.response.dto";
import type { CompanyUpdateRequestDto } from "@voyzu-modules/core/types/modules/companies/company.update.request.dto";
...
import {
  ...
  activateCompany,
  deactivateCompany,
} from "../server/lib/company.service";
