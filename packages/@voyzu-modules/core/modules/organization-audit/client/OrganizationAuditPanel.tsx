...
import { AuditPanel, type AuditPanelProps } from "@voyzu-modules/core/common/client";
import { detailLinkWithBackContext } from "@voyzu/ui-surface/client";

interface OrganizationAuditPanelProps extends Omit<AuditPanelProps, "onNavigate"> {
...
export function OrganizationAuditPanel({ auditHref, mutationId, ...props }: OrganizationAuditPanelProps) {
  ...
  const resolveHref = useCallback((href: string, resolvedMutationId?: string | null) => {
    ...
    return target ? detailLinkWithBackContext(target, "organizationAudit", pathname) : undefined;
  }, [pathname]);
