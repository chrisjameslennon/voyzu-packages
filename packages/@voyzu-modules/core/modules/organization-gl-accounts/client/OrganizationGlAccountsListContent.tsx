...
import { getGlAccountTypeColor, getStatusSemanticColor } from "@voyzu-modules/core/common/client";
import { Deactivate, Delete } from "@voyzu-modules/core/common/gl-accounts/domain/operation-policy";
...
import type { GlAccountCreateRequestDto, GlAccountResponseDto } from "@voyzu-modules/core/types/modules/gl-accounts";
import {
  Badge,
  Breadcrumbs,
  Button,
