...
import { getStatusSemanticColor, StandardSettingsReadOnlyAlert, type DetailBackSource } from "@voyzu-modules/core/common/client";
import { AssignTarget } from "@voyzu-modules/core/common/financial-document-defaults/domain/operation-policy";
import type { BankCashAccountResponseDto } from "@voyzu-modules/core/types/modules/bank-cash-accounts";
import type { FinancialDocumentDefaultPatchRequestDto, FinancialDocumentDefaultResponseDto } from "@voyzu-modules/core/types/modules/financial-document-defaults";
