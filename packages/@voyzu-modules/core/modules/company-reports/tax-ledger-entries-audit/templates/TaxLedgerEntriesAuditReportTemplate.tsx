import type { TaxLedgerEntriesAuditFieldDto, TaxLedgerEntriesAuditResponseDto } from "@voyzu-modules/core/types/modules/company-reports";

import { journalEntriesReportCss, journalEntriesReportStyles as styles } from "./journal-entries-report.css";

function Field({ field }: { field: TaxLedgerEntriesAuditFieldDto }) {
  return (
...
function JsonField({ field }: { field: TaxLedgerEntriesAuditFieldDto }) {
  return (
...
interface TaxLedgerEntriesAuditReportTemplateProps {
  data: TaxLedgerEntriesAuditResponseDto;
  generatedAt: string;
...
export function TaxLedgerEntriesAuditReportTemplate({ data, generatedAt, showSnapshotData }: TaxLedgerEntriesAuditReportTemplateProps) {
  return (
    <div className={styles.reportPage}>
      ...
      <section className={styles.reportSection}>
        ...
        <div className={styles.reportSubTitle}>Tax Ledger Entries</div>
        ...
        <div className={styles.journalList}>
          ...
          {data.entries.length === 0 && (
            <div className={styles.empty}>No tax ledger entries found for this date range.</div>
          )}
        </div>
      </section>
