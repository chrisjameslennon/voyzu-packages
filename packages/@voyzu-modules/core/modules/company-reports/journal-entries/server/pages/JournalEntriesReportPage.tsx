...
export async function JournalEntriesReportPage({ surface }: ReportPageProps = {}) {
  ...
  const initialData = await getJournalEntries(company.id, fromDate, toDate);

  if (surface?.unframed) {
    return (
      <JournalEntriesReportTemplate
        data={initialData}
