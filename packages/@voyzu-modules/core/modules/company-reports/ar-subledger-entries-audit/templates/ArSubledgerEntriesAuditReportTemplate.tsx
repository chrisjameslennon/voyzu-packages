import type { ArSubledgerEntriesAuditFieldDto, ArSubledgerEntriesAuditResponseDto } from "@voyzu-modules/core/types/modules/company-reports";

import { journalEntriesReportCss, journalEntriesReportStyles as styles } from "./journal-entries-report.css";

function Field({ field }: { field: ArSubledgerEntriesAuditFieldDto }) {
  return (
...
function JsonField({ field }: { field: ArSubledgerEntriesAuditFieldDto }) {
  return (
...
interface ArSubledgerEntriesAuditReportTemplateProps {
  data: ArSubledgerEntriesAuditResponseDto;
  generatedAt: string;
...
export function ArSubledgerEntriesAuditReportTemplate({ data, generatedAt, showSnapshotData }: ArSubledgerEntriesAuditReportTemplateProps) {
  return (
    <div className={styles.reportPage}>
      ...
      <section className={styles.reportSection}>
        ...
        <div className={styles.reportSubTitle}>AR Subledger Entries</div>
        ...
        <div className={styles.journalList}>
          ...
          {data.entries.length === 0 && (
            <div className={styles.empty}>No AR subledger entries found for this date range.</div>
          )}
        </div>
      </section>
