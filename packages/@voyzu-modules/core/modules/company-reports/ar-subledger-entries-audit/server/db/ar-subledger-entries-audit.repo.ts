...
import type { ArSubledgerEntriesAuditEntryDto, ArSubledgerEntriesAuditFieldDto } from "@voyzu-modules/core/types/modules/company-reports";

const ENTRY_FIELDS: Array<{ key: string; label: string }> = [
  { key: "id", label: "ID" },
  { key: "ar_subledger_entry_code", label: "AR Subledger Entry Code" },
  ...
  { key: "ar_counterparty_id", label: "AR Counterparty ID" },
...
function fieldsFromRow(row: Record<string, unknown>): ArSubledgerEntriesAuditFieldDto[] {
