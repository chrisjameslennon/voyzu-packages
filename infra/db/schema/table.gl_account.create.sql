...
CREATE TABLE gl_account (
    ...
    CONSTRAINT fk_account_category
        FOREIGN KEY (company_id, account_category_id)
        REFERENCES gl_account_category(company_id, id),

    CONSTRAINT uq_gl_account_company_code UNIQUE (company_id, code),
    CONSTRAINT uq_gl_account_company_id UNIQUE (company_id, id)
);