...
DROP TABLE IF EXISTS ap_control_account CASCADE;

CREATE TABLE ap_control_account (
    ...
    CONSTRAINT pk_ap_control_account PRIMARY KEY (company_id, code),
    CONSTRAINT fk_ap_control_account_company FOREIGN KEY (company_id) REFERENCES company(id),
    CONSTRAINT fk_ap_control_account_gl_account FOREIGN KEY (company_id, gl_account_id) REFERENCES gl_account(company_id, id)
);