DROP TABLE IF EXISTS gl_account_category CASCADE;
...
CREATE TABLE gl_account_category (
    ...
    CONSTRAINT uq_gl_account_category_company_code UNIQUE (company_id, code),
    CONSTRAINT uq_gl_account_category_company_id UNIQUE (company_id, id)
);
