...
DROP TABLE IF EXISTS tax_ledger_entry_header CASCADE;
DROP TABLE IF EXISTS tax_ledger_entry CASCADE;

CREATE TABLE tax_ledger_entry_header (
    ...
    CONSTRAINT fk_tax_header_company          FOREIGN KEY (company_id)          REFERENCES company(id),
    ...
    CONSTRAINT fk_tax_header_financial_period FOREIGN KEY (financial_period_id) REFERENCES fiscal_period(id),
    CONSTRAINT fk_tax_header_base_currency    FOREIGN KEY (base_currency_code)  REFERENCES currency(code)
);
