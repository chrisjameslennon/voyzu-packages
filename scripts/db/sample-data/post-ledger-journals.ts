...
import type { LedgerJournalRequestDto } from "@voyzu/core/types/modules/financial-document-processing-engine";
import type { LedgerJournalReversalRequestDto } from "@voyzu/core/types/modules/financial-document-processing-engine";
import { processLedgerJournalReversal } from "@voyzu/core/financial-document-processing-engine/ledger_journal/lib/ledger-journal-reversal.service";
import { processLedgerJournal } from "@voyzu/core/financial-document-processing-engine/ledger_journal/lib/ledger-journal.service";
